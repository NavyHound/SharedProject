        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="user-block block text-center">
                    <div class="avatar"><img src="{{asset('img/avatar-1.jpg')}}" alt="..." class="img-fluid">
            ...
            <div class="col-lg-4">
                <div class="user-block block text-center">
                    <div class="avatar"><img src="{{asset('img/avatar-4.jpg')}}" alt="..." class="img-fluid">
            ...
            <div class="col-lg-4">
                <div class="user-block block text-center">
                    <div class="avatar"><img src="{{asset('img/avatar-6.jpg')}}" alt="..." class="img-fluid">
        ...
        <div class="public-user-block block">
            <div class="row d-flex align-items-center">
                <div class="col-lg-4 d-flex align-items-center">
                    ...
                    <div class="avatar"> <img src="{{asset('img/avatar-1.jpg')}}" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Tomas Hecktor</strong><span class="d-block">@tomhecktor</span></a>
                </div>
